...
import numpy as np
from generator_util.dataloading.data_loader import DataLoader
from generator_util.dataloading.dataset import Dataset
from generator_util.utilities.file_and_folder_operations import join
...
if __name__ == '__main__':
    maybe_download_and_prepare_cifar(target_dir="E:\\shunjieg\\datasets\\cifar10\\")