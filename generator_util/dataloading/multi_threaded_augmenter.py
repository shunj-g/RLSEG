...
@software: multi_threaded_augmenter
@file: multi_threaded_augmenter.py
        ...
        if len(self._processes) == 0:
            ...
            for i in range(self.num_processes):
                self._queues.append(Queue(self.num_cached_per_queue))
                                                                     #      queue,      data_loader,    transform,  thread_id,  seed,       abort_event
